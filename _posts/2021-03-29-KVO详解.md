...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Yx2pTX42TbA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<video id="video" controls="" preload="none" poster="https://t7.baidu.com/it/u=2168645659,3174029352&fm=193&f=GIF">
      <source id="mp4" src="https://img.tukuppt.com/video_show/15653652/01/22/71/620f42b183ae0.mp4">
</video>
	  
	  
<audio id="audio" controls="" preload="none">
      <source id="mp3" src="http://down.kjzhan.com/soft2020/d1/4x.mp3">
</audio>

```mermaid
graph LR;
　　index.php-->|加载|vendor/autoload.php-->|加载|compose/autoload_real.php-->ComposerAutoloaderInit::getLoader;
   compose/autoload_real.php-->|调用|ClassLoader::register;
　　ClassLoader::register-->|注册|Spl_autoload_register(classLoader::loadClass);
　　ComposerAutoloaderInit::getLoader-->|加载|composer/autoload_static.php-->|调用|ComposerStaticInit::getInitializer-->Composer/ClassLoader.php;
  subgraph 为loader的属性赋值
  Composer/ClassLoader.php---c[$prefixLengthsPsr4<br>$prefixDirPsr4<br>$failbackDirsPsr4<br>$prefixesPsr0<br>$failbackDirPsr0<br>$classMap<br>];
  end
```
